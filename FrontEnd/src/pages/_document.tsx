...
export default class MyDocument extends Document {
  render(): ReactElement {
    ...
    const favicon16Prod = `${pathPrefix}/images/icon16.ico`;
    const favicon32Prod = `${pathPrefix}/images/icon32.ico`;
    const favicon128Prod = `${pathPrefix}/images/icon128.ico`;
    const favicon16Dev = `${pathPrefix}/images/icon16.ico`;
    const favicon32Dev = `${pathPrefix}/images/icon32.ico`;
    const favicon128Dev = `${pathPrefix}/images/icon128.ico`;
      ...
      <Html lang="en">
        <Head>
          ...
          <link
            rel="icon"
            type="image/png"
            href={isLocalDev ? favicon128Dev : favicon128Prod}
            sizes="128x128"
          />
        </Head>
